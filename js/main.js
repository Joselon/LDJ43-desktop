...
function init() {
    ...
    notebook.scaleX=notebook.scaleY=h/1440;
    bkg.scaleX=bkg.scaleY=h/1440;
    ...
    mobile.y = h+23*h/72;//window.innerHeight-window.innerHeight/10;//1900;// JNO stage.canvas.heigt-200;
    mobile.x = 10*w/46;//window.innerWidth-2*window.innerWidth/10;//400;
    ...
    notebook.y = h+23*h/72;//1900;//stage.canvas.height*2+stage.canvas.height-50;JNO
    notebook.x = w/24; //80;
    ...
    bkgMobile.y = h+361*h/720;//2161;//stage.canvas.height*2+stage.canvas.height-50;JNO
    ...
    //content.scaleX=content.scaleY=h/1440;
