...
function loadMobile(){
 ...
 //if(stage){
  ...
  //  }
    ...
    mobileC.x = 5*w/24;//400;//stage.canvas.width/4;
    mobileC.y=h+23*h/72;//1900;// window.innerHeight*2+window.innerHeight-50;
...
function cambiaFondo(){
   // mobile.removeChild(mobile.bmp); Cambiar por no visible
    ...
    mobileC.bmp.x = -250*h/1440;
    mobileC.bmp.y=-25*h/1440;
    mobileC.bmp.scaleX=3*h/1440;
    mobileC.bmp.scaleY=3*h/1440;
    mobileC.addChild(mobileC.bmp);
    mobileC.addChild(contactView);
    contactView.x = 200*h/1440;
